...
```{r boost-actual-vs-pred, fig.width=7, fig.height=5}
library(ggplot2)

predict(boost_final_fit, new_data = data_2025)

boost_preds_2025 <- predict(boost_final_fit, new_data = data_2025) |>
  dplyr::bind_cols(data_2025)
