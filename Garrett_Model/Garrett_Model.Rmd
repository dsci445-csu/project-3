...
model <- Arima(train_ts, order = c(5, 1, 1), seasonal = c(2, 1, 2))
...
Submission 4 garnered an RMSLE of 4.01083, the best so far. Will be attempting to build on this model from this point forward.
